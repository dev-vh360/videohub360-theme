...
/**
    ...
    function scrollToTop() {
        window.VH360ScrollContext && window.VH360ScrollContext.scrollElementIntoView ? window.VH360ScrollContext.scrollElementIntoView($('.vh360-members-controls').get(0), 20, { behavior: 'smooth' }) : $('html, body').animate({
