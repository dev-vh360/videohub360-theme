<?php
/**
 * Archive Template for Bulletins
 *
...
$vh360_header_title = get_theme_mod('vh360_bulletins_header_title', __('Bulletins & Announcements', 'videohub360-theme'));
$vh360_header_desc  = get_theme_mod('vh360_bulletins_header_description', __('Stay updated with the latest news and important announcements.', 'videohub360-theme'));
