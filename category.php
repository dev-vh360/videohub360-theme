...
// Header visibility for category archives (always show for categories)
$vh360_show_header  = true;
$vh360_header_title = single_term_title('', false);
$vh360_header_desc  = term_description();
?>

<div id="primary" class="content-area vh360-blog-archive vh360-blog-archive-category <?php echo $vh360_show_header ? '' : 'vh360-template-header-off'; ?>">
