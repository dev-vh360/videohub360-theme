 ...
 *
 * Unified tab for creating and managing Live Rooms.
 * Contains both the creation form and the list of existing Live Rooms.
 *
...
<div class="vh360-dashboard-section vh360-dashboard-live-rooms">
    <header class="vh360-dashboard-section-header">
        ...
        <p class="vh360-dashboard-section-subtitle">
            <?php esc_html_e('Create and manage your Live Rooms.', 'videohub360-theme'); ?>
        </p>
    </header>
        ...
        <?php else : ?>
            <div class="vh360-dashboard-empty">
                ...
                <p class="vh360-dashboard-empty-text">
                    <?php if ($can_host_live_rooms) : ?>
                        <?php esc_html_e('Use the form above to create your first Live Room.', 'videohub360-theme'); ?>
                    <?php else : ?>
