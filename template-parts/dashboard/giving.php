                ...
                <?php else : ?>
                    <form id="vh360-giving-form" class="vh360-giving-form">
                        <div class="vh360-giving-form-grid">
                            ...
                            <?php if (!empty($options['enable_anonymous'])) : ?><label class="vh360-giving-check vh360-giving-field-full"><input type="checkbox" name="anonymous" value="1"><span><?php esc_html_e('Give anonymously in public reports', 'videohub360-memberships'); ?></span></label><?php endif; ?>
