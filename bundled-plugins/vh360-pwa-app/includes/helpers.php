...
/**
 * Return normalized public path prefixes that must never receive cached player HTML.
 * The VideoHub360 post type rewrite is site-configurable, so this is generated by
 * WordPress instead of relying on a worker-side list of guessed slugs.
 */
function vh360_pwa_get_vh360_network_only_paths() : array {
	$paths = array();
	$post_type = get_post_type_object( 'videohub360' );
