                    ...
                    <div class="vh360-studio-overlays-content" data-overlays-content>
                        ...
                        <section id="vh360-overlays-panel-bible-control" class="vh360-studio-bible-panel" role="tabpanel" aria-labelledby="vh360-overlays-tab-bible vh360-overlays-section-control" data-overlays-panel data-module="bible" data-section="control" hidden>
                            <div class="vh360-studio-bible-stack">
                                ...
                                <label for="vh360-bible-start-verse"><?php esc_html_e( 'Start verse', 'videohub360-studio' ); ?></label><select id="vh360-bible-start-verse" data-bible-start-verse></select><label for="vh360-bible-end-verse"><?php esc_html_e( 'End verse', 'videohub360-studio' ); ?></label><select id="vh360-bible-end-verse" data-bible-end-verse></select>
                                <div class="vh360-studio-bible-reading" data-bible-reading aria-live="polite"></div><div class="vh360-studio-bible-status"><p><strong><?php esc_html_e( 'Preview', 'videohub360-studio' ); ?></strong> <span data-bible-preview-page></span></p><p><strong><?php esc_html_e( 'Program', 'videohub360-studio' ); ?></strong> <span data-bible-program-page></span></p></div>
