...
class VH360_Studio_Admin {
    ...
    public function register_settings() {
        $settings = array(
            ...
            'vh360_studio_publitio_direct_max_size'       => 'absint',
        ...
        <div class="wrap vh360-studio-admin">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table" role="presentation"><tbody>
                    ...
                    <tr><th><label for="vh360_studio_publitio_direct_max_size"><?php esc_html_e( 'Publitio direct upload max size (bytes)', 'videohub360-studio' ); ?></label></th><td><input type="number" min="1048576" id="vh360_studio_publitio_direct_max_size" name="vh360_studio_publitio_direct_max_size" value="<?php echo esc_attr( get_option( 'vh360_studio_publitio_direct_max_size', 314572800 ) ); ?>"><p class="description"><?php esc_html_e( 'Direct browser upload is faster because the file skips WordPress, but very large recordings may use significant browser memory. Use server relay for very long recordings.', 'videohub360-studio' ); ?></p></td></tr>
                    ...
                    <tr><th><label for="vh360_studio_bunny_stream_cdn_hostname"><?php esc_html_e( 'Bunny Stream CDN hostname', 'videohub360-studio' ); ?></label></th><td><input type="text" class="regular-text" id="vh360_studio_bunny_stream_cdn_hostname" name="vh360_studio_bunny_stream_cdn_hostname" value="<?php echo esc_attr( get_option( 'vh360_studio_bunny_stream_cdn_hostname', '' ) ); ?>"><p class="description"><?php esc_html_e( 'Optional Bunny CDN hostname for direct asset URLs. Bunny iframe embeds always use the Bunny Stream player endpoint.', 'videohub360-studio' ); ?></p></td></tr>
    ...
    private function render_server_readiness() {
        ...
        $rows = array(
            ...
            __( 'Publitio direct upload max size', 'videohub360-studio' ) => size_format( absint( get_option( 'vh360_studio_publitio_direct_max_size', 314572800 ) ) ),
