...
class VH360_Studio_Admin {
        ...
        <div class="wrap vh360-studio-admin">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table" role="presentation"><tbody>
                    ...
                    <tr><th><label for="vh360_studio_publitio_direct_max_size"><?php esc_html_e( 'Publitio direct upload max size (bytes)', 'videohub360-studio' ); ?></label></th><td><input type="number" min="1048576" id="vh360_studio_publitio_direct_max_size" name="vh360_studio_publitio_direct_max_size" value="<?php echo esc_attr( vh360_studio_publitio_direct_upload_max_size() ); ?>"><p class="description"><?php esc_html_e( 'Direct browser upload is faster because the file skips WordPress, but very large recordings may use significant browser memory. Use server relay for very long recordings.', 'videohub360-studio' ); ?></p></td></tr>
    ...
    private function render_server_readiness() {
        ...
        $rows = array(
            ...
            __( 'Publitio direct upload max size', 'videohub360-studio' ) => size_format( vh360_studio_publitio_direct_upload_max_size() ),
