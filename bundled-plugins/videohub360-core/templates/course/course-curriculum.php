                        ...
                        <span class="vh360-lesson-meta">
                            ...
                            <?php else :
                                ...
                                if ( ! empty( $lesson_plan ) ) {
                                    ...
                                    is_user_logged_in() && (
                                        ( function_exists( 'vh360_user_is_enrolled_in_course' ) && vh360_user_is_enrolled_in_course( get_current_user_id(), $term_id ) )
                                        || ( function_exists( 'vh360_user_has_course_entitlement' ) && vh360_user_has_course_entitlement( get_current_user_id(), $term_id ) )
                                    )
                                ) {
